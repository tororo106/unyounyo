...
(function (root, factory) {
  ...
  class PuyoEngine {
    ...
    hardDrop() {
      // Intentional no-op: the original game has no instant hard-drop for this
      // mode, only an accelerated soft drop. Kept as a method so remapped
      // buttons calling it never throw; it simply does nothing.
    }
